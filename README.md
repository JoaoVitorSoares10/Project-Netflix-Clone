...
O Netflix Clone é um projeto para pratica de desenvolvimento front-end, sendo uma aplicação que simula a página inicial do catalogo de filmes da netflix. Os dados dos filmes são disponibilidados pela API do site The Movie Database [https://www.themoviedb.org/?language=pt-BR]
